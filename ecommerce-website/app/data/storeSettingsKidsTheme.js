...
export const storeSettingsKidsTheme = {
  ...
  details: {
    ...
    contact: "+92 334 000 2625",
    whatsapp: "+92 334 000 2625",
    email: "babiesnbaba@gmail.com",
  },
  // SEO fallback defaults (overridden by DB brandSetting)
  metaTags: {
    ...
    keywords: "baby store, baby clothes, baby products, pakistan",
    ogImage: "",
  },
  favicon: "/favicon.ico",
  globalDiscount: { enabled: false, percent: 0, label: "" },
  maxQtyPerProductPerOrder: 0,
};
