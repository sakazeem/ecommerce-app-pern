...
export default function QuickShopModal({ isOpen, setIsOpen, onClose, slug }) {
  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed md:inset-0 top-5 overflow-y-auto">
          <div className="flex items-center justify-center p-4 max-md:p-2 h-full">
            ...
            >
              <DialogPanel className="w-full max-w-2xl  rounded-2xl overflow-hidden inline-block md:p-20 max-md:px-2 max-md:py-2">
                {isLoading ? (
                  <SpinLoader />
                ) : !product ? (
                  ...
                  <section className="w-full rounded-2xl bg-white shadow-xl relative">
                    ...
                    <section className="w-full items-start relative rounded-2xl max-md:overflow-y-auto custom-scrollbar/ max-md:max-h-[calc(100vh-100px)]">
                      <button
                        onClick={onClose}
                        aria-label="Close modal"
                      ...
                      <div className="max-md:mt-4 px-8 py-8 flex flex-col max-md:h-full">
