  ...
  return (
    <div
      ...
      className={`group relative rounded-xl border-2 bg-white transition-all duration-200 mb-4 ${
        isDragging
          ...
          : isHidden
            ? "border-dashed border-gray-300 opacity-60 shadow-sm"
    ...
    >
      ...
      <div className="flex gap-2 items-center absolute left-4 top-2">
        ...
        {isHidden && (
          <span className="text-xs font-semibold text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full border border-gray-200">
            Hidden
          </span>
        )}
      </div>
      <div className="pl-14 pr-4 py-6 pt-10">
        <SectionForm
          section={section}
          index={index}
          total={total}
...
const Homepage = () => {
  ...
  const handleAdd = (type) => {
    ...
    setSections((prev) => [
      ...prev,
      { id: uuidv4() + "_uuid4", type, title: null, config },
    ]);
  };
  ...
  const AddSectionSelect = ({ className = "" }) => (
    <select
      onChange={(e) => {
      ...
      className={`border-2 border-gray-200 rounded-xl px-4 py-2.5 bg-white hover:border-blue-400 focus:border-blue-500 focus:outline-none transition-all cursor-pointer font-medium text-gray-700 ${className}`}
    >
        ...
        <div className="mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap gap-4 justify-between items-center">
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                {orderChanged && (
                  ...
                  >
                    <GripVertical size={18} /> Update Order
                  </button>
                )}
                <button
                  onClick={handleSave}
          ...
          {!loading && sections.length === 0 && (
            <div className="text-center py-24 bg-white border-2 border-dashed border-gray-300 rounded-2xl">
              ...
              >
                <Plus size={20} /> Add Your First Section
              </button>
            </div>
          )}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <p className="text-xs text-gray-500">
                  💡 Drag sections to reorder, or use ∧ ∨ arrows
                </p>
              </div>
          ...
          {!loading && sections.length > 0 && (
            <div className="rounded-xl border-2 border-dashed border-gray-200 bg-white mt-4 mb-8">
              <div className="px-6 py-4">
                <div className="flex gap-3 flex-wrap">
                  <AddSectionSelect className="flex-1" />
                  {orderChanged && (
                    <button
                      onClick={handleUpdateOrder}
